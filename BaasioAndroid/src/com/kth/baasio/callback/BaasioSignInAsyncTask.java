...
public abstract class BaasioSignInAsyncTask extends AsyncTask<Void, BaasioException, BaasioUser> {

    BaasioSignInCallback mCallback;

    private Handler mHandler = new Handler(Looper.getMainLooper());

    public BaasioSignInAsyncTask(BaasioSignInCallback callback) {
