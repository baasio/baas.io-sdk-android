...
public class Baas {
    ...
    public void uninit(Context context) {
        if (Baas.io().isGcmEnabled()) {
            try {
                ...
                LogUtils.LOGD(TAG, "GCMRegistrar.onDestroy failed", e);
            }
        }
    }
    ...
    public HttpResponse uploadFileRequest(HttpMethod method, MultipartEntity entity,
        ...
        LogUtils.LOGI(TAG, "Client.httpRequest(): url: " + url);
    ...
    public <T> T httpRequest(HttpMethod method, Class<T> cls, Map<String, Object> params,
        ...
        if (accessToken != null) {
            ...
            LogUtils.LOGI(TAG, "Authorization: " + auth);
        }
        ...
        if (responseEntity != null) {
            if (responseEntity.getBody() != null) {
                LogUtils.LOGI(TAG, "Client.httpRequest(): reponse body: "
